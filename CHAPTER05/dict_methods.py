...
len(marks)
#len method is used to get the number of key value pairs in the dictionary, it will return the number of key value pairs in the dictionary.
print(len(marks))
#in terminal while using len method we don't need to print the print thing.
